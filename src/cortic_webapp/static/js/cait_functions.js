...
async function enable_drawing_mode(mode) {
  try {
...
async function set_motor_power(hub_name, motor_name, power) {
  try {
...
async function init_pid(kp, ki, kd) {
  try {
...
async function update_pid(error) {
  try {
