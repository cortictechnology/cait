...
Blockly.JavaScript['add_pipeline_node'] = function (block) {
  ...
  if (dropdown_node == "rgb") {
    var code = '<["add_rgb_cam_node", 640, 360, False], ["add_rgb_cam_preview_node"]>';
  }
  else if (dropdown_node == "stereo") {
    var code = '<["add_stereo_cam_node"], ["add_stereo_frame_node"]>';
  }
...
Blockly.JavaScript['init_pid'] = function (block) {
  ...
  var code = "await init_pid(" + String(number_kp) + ", " + String(number_ki) + ", " + String(number_kd) + ");\n";
  return code
};
...
Blockly.JavaScript['vision_draw_stereo_frame'] = function (block) {
  var code = "await enable_drawing_mode('Depth Mode');\n";
  return code;
};
...
Blockly.JavaScript['vision_draw_detected_face'] = function (block) {
  var code = "await enable_drawing_mode('Face Detection');\n";
  return code;
};

Blockly.Python['vision_draw_detected_face'] = function (block) {
  var code = "cait.essentials.enable_drawing_mode('Face Detection')\n";
  return code;
};
...
Blockly.JavaScript['vision_draw_recognized_face'] = function (block) {
  var code = "await enable_drawing_mode('Face Recognition');\n";
  return code;
};

Blockly.Python['vision_draw_recognized_face'] = function (block) {
  var code = "cait.essentials.enable_drawing_mode('Face Recognition')\n";
  return code;
};
...
Blockly.JavaScript['vision_draw_detected_objects'] = function (block) {
  var code = "await enable_drawing_mode('Object Detection');\n";
  return code;
};

Blockly.Python['vision_draw_detected_objects'] = function (block) {
  var code = "cait.essentials.enable_drawing_mode('Object Detection')\n";
  return code;
};
...
Blockly.JavaScript['vision_face_emotions'] = function (block) {
  var code = "await face_emotions_estimation()";
  return [code, Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.JavaScript['vision_draw_face_emotions'] = function (block) {
  var code = "await enable_drawing_mode('Face Emotions');\n";
  return code;
};

Blockly.Python['vision_draw_face_emotions'] = function (block) {
  var code = "cait.essentials.enable_drawing_mode('Face Emotions')\n";
  return code;
};

Blockly.JavaScript['vision_facemesh'] = function (block) {
  var code = "await facemesh_estimation()";
  return [code, Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.JavaScript['vision_draw_facemesh'] = function (block) {
  var code = "await enable_drawing_mode('Face Mesh');\n";
  return code;
};
...
Blockly.JavaScript['vision_draw_hand_landmarks'] = function (block) {
  var code = "await enable_drawing_mode('Hand Landmarks');\n";
  return code;
};

Blockly.Python['vision_draw_hand_landmarks'] = function (block) {
  var code = "cait.essentials.enable_drawing_mode('Hand Landmarks')\n";
  return code;
};
...
Blockly.JavaScript['motor_power'] = function (block) {
  ...
  var code = "await set_motor_power('" + hub_name + "', '" + motor_name + "', " + String(number_power) + ");\n";
  return code;
};
...
Blockly.JavaScript['update_pid'] = function (block) {
  ...
  var code = "await update_pid(" + String(number_error) + ")";
  return [code, Blockly.JavaScript.ORDER_NONE];
};
