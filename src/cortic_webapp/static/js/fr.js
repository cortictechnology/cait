...
Blockly.Msg["SETUP"] = "Installer";
Blockly.Msg["MAIN"] = "Principal";
Blockly.Msg["SET_PARAMS"] = "Définir les propriétés %1 %2 %3 sur %4 ";
Blockly.Msg["SLEEP"] = "sleep for %1 %2";
Blockly.Msg["SLEEP_TOOLTIP"] = "Set a sleep time for the program";
Blockly.Msg["INIT_VISION"] = "Initialiser la vision avec %1 %2";
Blockly.Msg["ADD_NODE"] = "Add %1 node to pipeline";
Blockly.Msg["ADD_NODE_TOOLTIP"] = "Add a depthai node to pipeline";
Blockly.Msg["INIT_VOICE"] = "initialiser la voix avec le mode %1 %2 à l'aide du compte %3 dans %4 %5";
Blockly.Msg["INIT_NLP"] = "initialiser nlp avec le modèle %1";
Blockly.Msg["INIT_CONTROL"] = "Initialiser le contrôle avec %1 %2";
Blockly.Msg["EV3_MOTOR"] = "EV3 Moteur: %1";
Blockly.Msg["EV3_MOTOR_TOOLTIP"] = "Bloc moteur pour moyeu EV3";
Blockly.Msg["RI_MOTOR"] = "Robot Inventor Moteur: %1";
Blockly.Msg["RI_MOTOR_TOOLTIP"] = "Bloc moteur pour moyeu Robot Inventor";
Blockly.Msg["ADD_CONTROL_HUB"] = "ajouter un hub %1";
Blockly.Msg["ADD_CONTROL_HUB_TOOLTIP"] = "Ajouter un hub lego pour l'initialisation du contrôle";
Blockly.Msg["INIT_HOME"] = "Initialiser la maison intelligente";
Blockly.Msg["FACE_DETECT"] = "Détecter le visage";
Blockly.Msg["FACE_DETECT_TOOLTIP"] = "Détecter tous les visages des personnes dans la scène";
Blockly.Msg["FACE_RECOGNIZE"] = "Reconnaître le visage";
Blockly.Msg["FACE_ADD"] = "Ajouter un visage Nom %1";
Blockly.Msg["FACE_DELETE"] = "Supprimer le visage Nom %1";
Blockly.Msg["OBJECT_DETECT"] = "Détecter l'objet";
Blockly.Msg["IMAGE_CLASSIFY"] = "classer l'image";
Blockly.Msg["LISTEN"] = "Ecoutez";
Blockly.Msg["SAY"] = "Dire %1";
Blockly.Msg["COMMENT"] = "Commentaire %1";
Blockly.Msg["ANALYZE"] = "Analyser %1";
Blockly.Msg["GET_NAME"] = "De l'intention %1 obtenir le nom";
Blockly.Msg["EMPTY_DICT"] = "Créer un dictionnaire vide";
Blockly.Msg["DICT_KEYS"] = "À partir du dictionnaire %1 obtenir la liste des clés";
Blockly.Msg["DICT_VAL"] = "À partir du dictionnaire %1 obtenir la clé %2 la valeur de";
Blockly.Msg["DICT_SET_VAL"] = "À partir du dictionnaire %1，définir la clé %2 la valeur de %3 ";
Blockly.Msg["DICT_REMOVE_VAL"] = "À partir du dictionnaire %1，supprimer la valeur de %2";
Blockly.Msg["DICT_ADD_VAL"] = "À partir du dictionnaire %1，ajouter la valeur %3 à la clé %2 ";
Blockly.Msg["SET_MOTOR_GROUP"] = "régler la vitesse du groupe moteur %1 %2 ";
Blockly.Msg["SET_MOTOR_ANGLE"] = "Sur% 1, faire tourner le moteur% 2 à% 3% 4 degré (s)";
Blockly.Msg["SET_MOTOR_SPEED"] = "Sur le %1, régler la vitesse du moteur %2 %3 sur %4 pendant %5 secondes";
Blockly.Msg["SET_MOTOR_ROTATE"] = "Sur le %1, faire tourner le moteur %2 pour %3 %4 degré(s)";
Blockly.Msg["MOVE_MOTOR"] = "déplacer le groupe de moteurs：groupe de moteurs %1 direction %2";
Blockly.Msg["TURN_MOTOR"] = "tourner le groupe de moteurs：groupe de moteurs %1 degré(s) %2";
Blockly.Msg["LIGHT_CONTROL"] = "pour la lumière %1 ，exécutez %2 %3 %4";
Blockly.Msg["MEDIA_CONTROL"] = "pour le lecteur multimédia %1 effectuez %2";
...
Blockly.Msg["SET_MOTOR_GROUP_TOOLTIP"] = "Execute motor speed controls concurrently";
Blockly.Msg["SET_MOTOR_ANGLE_TOOLTIP"] = "Rotate motor for certain degrees concurrently";
